...
namespace CapaNegocio
{
    public class CN_Categoria
    {
        ...
        public List<Categoria> Listar() // Llama al metodo listar y lista un objeto de categorias
        {
            return objcd_Categoria.Listar();
        }

        public int Registrar(Categoria obj, out string Mensaje) // Registrar recibe un objeto de categoria
        {
